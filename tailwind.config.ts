  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "pulse-slow": {
          "0%, 100%": { opacity: "0.3", transform: "translate(-50%, -50%) rotate(5deg) scale(1)" },
          "50%": { opacity: "0.4", transform: "translate(-50%, -50%) rotate(5deg) scale(1.05)" },
        },
        "slide-very-slow": {
      ...
      animation: {
        ...
        "slide-very-slow": "slide-very-slow 60s linear infinite",
      },
    },
  },
