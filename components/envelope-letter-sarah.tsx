    ...
    <div className="relative w-full max-w-md mx-auto">
          ...
          >
            ...
            <div className="absolute inset-0 bg-[#f8f8f8] rounded-lg border border-gray-100 shadow-[0_2px_10px_rgba(0,0,0,0.05)]">
              ...
              <div className="absolute bottom-6 right-6 font-mono text-[#9c2b7a] text-sm text-right">
                <p className="font-bold">MS. SARAH WILLIAMS</p>
                <p>789 OCEAN DRIVE</p>
                <p>MIAMI, FL 33139</p>
                <p>USA</p>
              </div>
      ...
      >
        ...
        <div className="flex flex-col p-6 pt-8 font-handwriting text-[#2c3e50] h-full overflow-hidden">
          ...
          <div className="mb-3">
            <p className="text-lg">Dearest Sarah,</p>
          </div>
          ...
          <div ref={contentRef} className="space-y-4 leading-6 text-base flex-1 overflow-y-auto pr-2 relative">
            <p>
              I hope this letter brings a smile to your face. I was reminiscing about our college days and felt
              compelled to write to you.
            </p>

            <p>
              Do you remember that road trip we took during spring break? The car breaking down in the middle of
              nowhere, and how we ended up having the most amazing adventure despite the setback? Those memories still
              make me laugh.
            </p>

            <p>
              Life has been quite the journey since then. I've been focusing on my garden lately - you'd be proud of how
              my roses have bloomed this year. I remember how you always had a green thumb.
            </p>

            <p>
              I saw a book the other day that reminded me of you - it was about sustainable architecture, your passion
              project in college. Have you continued pursuing that interest?
            </p>

            <p>
              I hope your family is doing well. Please give my love to everyone, and know that you're often in my
              thoughts even though miles separate us.
            </p>

            <div className="mt-4 mb-4">
              <p className="mb-1">With love and fond memories,</p>
              <p className="italic text-lg">Jane</p>
            </div>
