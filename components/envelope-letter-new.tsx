    ...
    <div className="relative w-full max-w-md mx-auto">
          ...
          >
            ...
            <div className="absolute inset-0 bg-[#f8f8f8] rounded-lg border border-gray-100 shadow-[0_2px_10px_rgba(0,0,0,0.05)]">
              ...
              <div className="absolute top-6 left-6 font-mono text-[#2d2b6e] text-sm">
                <p className="font-bold">MS. EMILY CARTER</p>
                <p>567 MAPLE AVENUE</p>
              ...
              <div className="absolute bottom-6 right-6 font-mono text-[#9c2b7a] text-sm text-right">
                <p className="font-bold">MR. ALEX THOMPSON</p>
                <p>890 PINE STREET</p>
      ...
      >
        ...
        <div className="flex flex-col p-6 pt-8 font-handwriting text-[#2c3e50] h-full overflow-hidden">
          ...
          <div className="mb-3">
            <p className="text-lg">Dear Alex,</p>
          </div>
          ...
          <div ref={contentRef} className="space-y-4 leading-6 text-base flex-1 overflow-y-auto pr-2 relative">
            <p>
              I hope this letter finds you enjoying the beautiful spring weather in Seattle. I've been meaning to write
              to you for weeks now, and finally found the perfect rainy afternoon to sit down with pen and paper.
            </p>

            <p>
              Do you remember our conversation about starting that hiking club? Well, I finally took the plunge and
              organized our first group hike last weekend. We had twelve people show up, and it was absolutely magical!
              The trail led us through old-growth forests and ended at a stunning waterfall.
            </p>

            <p>
              Your advice about "just starting, even if it's imperfect" really stuck with me. I kept overthinking the
              logistics, but then I remembered what you said and just posted the invitation. Sometimes the best
              adventures begin with a simple "yes" to the unknown.
            </p>

            <p>
              I've also been reading that book you recommended - "The Art of Slow Living." It's completely changed how I
              approach my daily routine. I now start each morning with ten minutes of quiet reflection, and it's amazing
              how much more centered I feel throughout the day.
            </p>

            <p>
              I'd love to hear about your latest photography project. Are you still working on that series about urban
              wildlife? Your last photos of the city foxes were absolutely breathtaking.
            </p>

            <p>
              Perhaps we could plan a weekend trip soon? I know a perfect cabin by the lake where we could disconnect
              from the digital world and reconnect with nature and good conversation.
            </p>

            <div className="mt-4 mb-4">
              <p className="mb-1">Looking forward to your reply,</p>
              <p className="italic text-lg">Emily</p>
            </div>
          </div>
        </div>
