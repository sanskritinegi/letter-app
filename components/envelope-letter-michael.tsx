    ...
    <div className="relative w-full max-w-md mx-auto">
          ...
          >
            ...
            <div className="absolute inset-0 bg-[#f8f8f8] rounded-lg border border-gray-100 shadow-[0_2px_10px_rgba(0,0,0,0.05)]">
              ...
              <div className="absolute bottom-6 right-6 font-mono text-[#9c2b7a] text-sm text-right">
                <p className="font-bold">MR. MICHAEL JOHNSON</p>
                <p>456 PARK AVENUE</p>
                <p>APT 789</p>
      ...
      >
        ...
        <div className="flex flex-col p-6 pt-8 font-handwriting text-[#2c3e50] h-full overflow-hidden">
          ...
          <div className="mb-3">
            <p className="text-lg">Dear Michael,</p>
          </div>
          ...
          <div ref={contentRef} className="space-y-4 leading-6 text-base flex-1 overflow-y-auto pr-2 relative">
            <p>I hope this letter finds you in good health and high spirits. It's been too long since we last spoke.</p>

            <p>
              I've been thinking about our last conversation about your new business venture. Your passion and
              dedication are truly inspiring, and I have no doubt that you will succeed in this new chapter of your
              life.
            </p>

            <p>
              Remember when we talked about taking risks and stepping outside of our comfort zones? Well, I've finally
              taken your advice and started that painting class I've been talking about for years. It's challenging but
              incredibly rewarding.
            </p>

            <p>
              I'd love to hear how things are progressing with your projects. Perhaps we could schedule a call soon to
              catch up properly.
            </p>

            <p>Until then, take care of yourself and don't work too hard. Life is about balance, after all.</p>
